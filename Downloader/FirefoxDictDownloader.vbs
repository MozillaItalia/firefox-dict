'	FIREFOX:DICT Downloader 0.1.1
'	GSolone (mozillaitalia.github.io/firefox-dict) - Ultima modifica: 20/2/22
...
'	---------------------------------------------------------------------------------------------------------------------------------------
' 	STORICO MODIFICHE
'		0.1.1- modifiche necessarie per puntare al nuovo URL del repository (https://github.com/MozillaItalia/firefox-dict).
